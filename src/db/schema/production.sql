...
INSERT INTO posts (creation_date, user_id, prompt_id, spicy_language, text)
  VALUES
    ...
    ('2022-01-09 09:00:00-08', 1, 1, FALSE, 'The agency helping unemployed Canadians re-enter the workforce would be called Resume Eh? '),
    ('2022-01-08 10:00:00-08', 1, 1, FALSE, 'Sheep shearing services would be provided by Ewe Beauty'),
    ('2022-01-08 09:00:00-08', 1, 1, FALSE, 'Rogain would be lead sponsor of the Joe Rogain Podcast'),
    ('2022-01-07 09:00:00-08', 1, 1, TRUE, 'When we needed a male dog for breeding we''d contact Bitch Please'),
    ('2022-01-06 09:00:00-08', 1, 1, FALSE, 'We''d be treating itchy mosquito bites with balm called Itch? Please.'),
    ('2022-01-05 14:00:00-08', 1, 1, FALSE, 'We''d cure dry eyes using Moist Your Eyes'),
    ('2022-01-04 12:00:00-08', 1, 1, FALSE, 'We''d buy custom doors from D''Your Way'),
    ('2022-01-02 11:00:00-08', 1, 1, FALSE, 'We''d buy fancy custom doors from Dior Ways'),
    ('2022-01-02 10:00:00-08', 1, 1, FALSE, 'Ladies could shop skincare products from Moisturize Her'),
    ('2022-01-01 09:00:00-08', 1, 1, FALSE, 'German men could shop skincare products from Moisturize Herre');
